...
import 'package:mynotes_app/extensions/list/filter.dart';
...
class NotesService {
  ...
  Stream<List<DatabaseNote>> get allNotes =>
      _notesStreamController.stream.filter((note) {
        ...
        if (currentuser != null) {
          ...
          throw UserShouldBeSetBeforeUpdatingAllNotes();
        }
      });
  ...
  Future<DatabaseNote> createNote({
    ...
    // Create and return the DatabaseNote object
  ...
  Future<void> open() async {
    ...
    try {
      ...
      await _cacheNotes(); // Moved here to cache notes after table creation
